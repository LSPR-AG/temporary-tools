// Class that integrates functions over boundary simplices (edges/faces) using piecewise interpolation

#ifndef DUNE_INTERPOLATIONINTEGRATORNUMERICAL_HH
#define DUNE_INTERPOLATIONINTEGRATORNUMERICAL_HH
...
public:
  ...
  double integrate( double (*f)(double), double err) {   
    ...
    std::cout << "---------------------------------- done integrating edge ---------------------------------" << std::endl << std::endl;
...
public:
  ...
  double integrate( double (*f)(double, double), double err) {
    ...
    std::cout << "---------------------------------- done integrating triangle ---------------------------------" << std::endl << std::endl;
...
#endif /** DUNE_INTERPOLATIONINTEGRATORNUMERICAL_HH **/